...
LOCAL_PATH := device/nexell/navi_ref/nxp4330_navi_ref
...
#recovery
PRODUCT_COPY_FILES += \
    $(LOCAL_PATH)/init.recovery.navi_ref.rc:root/init.recovery.$(PRODUCT_HARDWARE).rc
...
# fstab
PRODUCT_COPY_FILES += \
    $(LOCAL_PATH)/fstab.navi_ref:$(TARGET_COPY_OUT_VENDOR)/etc/fstab.$(PRODUCT_HARDWARE)
...
# input
PRODUCT_COPY_FILES += \
    vendor/nexell/external/tslib/ts.conf:$(TARGET_COPY_OUT_VENDOR)/etc/ts.conf \
    $(LOCAL_PATH)/input/pointercal:$(TARGET_COPY_OUT_VENDOR)/etc/pointercal \
    $(LOCAL_PATH)/input/TSC2007_Touchscreen.idc:$(TARGET_COPY_OUT_VENDOR)/usr/idc/TSC2007_Touchscreen.idc \
...
PRODUCT_COPY_FILES += \
    ...
    $(LOCAL_PATH)/bluetooth/BCM20710A1_001.002.014.0103.0117.hcd:$(TARGET_COPY_OUT_VENDOR)/firmware/BCM20710A1_001.002.014.0103.0117.hcd
