...
# Kernel & DTB Setting
TARGET_KERNEL_DEFCONFIG := s5p4418_navi_ref_pie_defconfig
TARGET_KERNEL_SRC := vendor/nexell/kernel/kernel-4.4.x
TARGET_KERNEL_ARCH := arm
DTB_OUTDIR := out/target/product/nxp4330_navi_ref/obj/KERNEL_OBJ
DTB_DIR := ${DTB_OUTDIR}/arch/arm/boot/dts
DTIMG_ARG :=${DTB_DIR}/s5p4418-navi_ref-rev00.dtb --id=0
DTIMG_ARG +=${DTB_DIR}/s5p4418-navi_ref-rev01.dtb --id=1
BOARD_PREBUILT_DTBOIMAGE := out/target/product/nxp4330_navi_ref/dtbo_navi_ref.img
...
#nonsecure=UBOOT_BIN
#param=PARAM_BIN
BOOT_LOGO := device/nexell/navi_ref/nxp4330_navi_ref/logo.bmp
...
UBOOT_BOOTARGS+=androidboot.hardware=navi_ref androidboot.console=ttyAMA3
...
UBOOT_RECOVERY_BOOTARGS+=androidboot.hardware=navi_ref androidboot.console=ttyAMA3
...
TARGET_RECOVERY_WIPE = device/nexell/navi_ref/nxp4330_navi_ref/recovery.wipe
...
DEVICE_MANIFEST_FILE := device/nexell/navi_ref/nxp4330_navi_ref/manifest.xml
DEVICE_PACKAGE_OVERLAYS := device/nexell/navi_ref/nxp4330_navi_ref/overlay

#sepolicy
BOARD_SEPOLICY_DIRS := device/nexell/navi_ref/nxp4330_navi_ref/sepolicy/vendor
BOARD_PLAT_PUBLIC_SEPOLICY_DIR := device/nexell/navi_ref/nxp4330_navi_ref/sepolicy/public
BOARD_PLAT_PRIVATE_SEPOLICY_DIR := device/nexell/navi_ref/nxp4330_navi_ref/sepolicy/private

# graphics
BOARD_EGL_CFG := device/nexell/navi_ref/nxp4330_navi_ref/egl.cfg
...
BOARD_BLUETOOTH_BDROID_BUILDCFG_INCLUDE_DIR := device/nexell/navi_ref/nxp4330_navi_ref/bluetooth
BOARD_CUSTOM_BT_CONFIG := device/nexell/navi_ref/nxp4330_navi_ref/bluetooth/vnd_navi_ref.txt
...
# sepolicy
BOARD_SEPOLICY_DIRS += \
	device/nexell/navi_ref/nxp4330_navi_ref/sepolicy
...
#recovery
TARGET_RECOVERY_FSTAB := device/nexell/navi_ref/nxp4330_navi_ref/fstab.navi_ref
